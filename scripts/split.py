...
if __name__ == "__main__":  # ← FIXED LINE
    ...
    parser.add_argument("--images", help="Path to images", default=BCCD_Path)
    ...
    print(annotation_num, len(trainval), len(test), len(train), len(val))  # Also fixed Python 3 print
